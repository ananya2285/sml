...
def app():
    ...
    oldbalanceOrg = st.sidebar.number_input('Old balance of sender account', value=0.0)
    newbalanceOrig = st.sidebar.number_input('New balance of sender account', value=0.0)
    oldbalanceDest = st.sidebar.number_input('Old balance of recipient account', value=0.0)
    newbalanceDest = st.sidebar.number_input('New balance of recipient account', value=0.0)
    isFlaggedFraud = st.sidebar.number_input('Is flagged as fraud', value=0)
